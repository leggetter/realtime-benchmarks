...
function RealtimeCoService(){BenchmarkService.apply(this,arguments);this.name="RealtimeCo";var a=this;loadOrtcFactory(IbtRealTimeSJType,function(b,e){null==e&&a._init(b)})}RealtimeCoService.prototype=new BenchmarkService;
RealtimeCoService.prototype._init=function(a){var b=this;this._client=a.createClient();this._client.setId("LatencyClient");this._client.setConnectionTimeout(15E3);this._client.setClusterUrl("http://ortc-developers.realtime.co/server/2.1/");this._client.onConnected=function(){b._client.subscribe(b._channelName,!0,function(a,c,d){d=JSON.parse(d);b._onMessage(d)});b._onReady()};this._client.onException=function(a,c){var d=c;"Invalid connection."==c&&(d+=" Please reload the page to authenticate again");
b._log("Error: "+d)};this._client.connect("2wFviN","NOT_USED_BECAUSE_AUTH_IS_SET_OFF_IN_THE_DASHBOARD")};RealtimeCoService.prototype.send=function(a){this._client.send(this._channelName,JSON.stringify(a))};RealtimeCoService.prototype.disconnect=function(){this._client.disconnect()};
