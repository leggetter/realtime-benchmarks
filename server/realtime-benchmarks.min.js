...
function RealtimeCoService(){BenchmarkService.apply(this,arguments);this.name="RealtimeCo";var a=this;loadOrtcFactory(IbtRealTimeSJType,function(b,d){null==d&&a._init(b)})}RealtimeCoService.prototype=new BenchmarkService;
RealtimeCoService.prototype._init=function(a){var b=this;this._client=a.createClient();this._client.setId("LatencyClient");this._client.setConnectionTimeout(15E3);this._client.setClusterUrl("http://ortc-developers.realtime.co/server/2.1/");this._client.onConnected=function(){b._client.subscribe(b._channelName,!0,function(a,c,e){e=JSON.parse(e);b._onMessage(e)});b._onReady()};this._client.onException=function(a,c){var e=c;"Invalid connection."==c&&(e+=" Please reload the page to authenticate again");
...
HydnaService.prototype.disconnect=function(){this.channel.close()};
function GoInstantService(){var a=this;BenchmarkService.apply(a,arguments);a.name="GoInstant";a.connectUrl="https://goinstant.net/ccf8fe39696c/benchmarks";a.publishConnection=null;a.publishBenchmark=null;a.subscribeConnection=null;a.subscribeBenchmark=null;goinstant.connect(a.connectUrl,{user:{id:"pub",displayName:"Publisher"}},function(b,d,c){if(b)throw b;a.publishConnection=d;a.publishBenchmark=c.channel("benchmark");a._createSubscribeConnection()})}GoInstantService.prototype=new BenchmarkService;
GoInstantService.prototype._createSubscribeConnection=function(){var a=this;goinstant.connect(a.connectUrl,{user:{id:"sub",displayName:"Subscriber"}},function(b,d,c){if(b)throw b;a.subscribeConnection=d;a.subscribeBenchmark=c.channel("benchmark");a.subscribeBenchmark.on("message",function(b){a._onMessage(b)});a._onReady()})};GoInstantService.prototype._handleResponse=function(a){if(a)throw a;};
GoInstantService.prototype.send=function(a){var b=this;b._log("sending: "+JSON.stringify(a));this.publishBenchmark.message(a,function(){b._handleResponse.apply(b,arguments)})};GoInstantService.prototype.disconnect=function(){this.publishConnection.disconnect();this.subscribeConnection.disconnect()};
